...
import "../styles/gamehistory1min.css";
const API_URL = "https://tigerclubbackend.onrender.com";

const GameHistory1Min = () => {
  ...
  const fetchHistory = async (p = 1) => {
    try {
const res = await fetch(`${API_URL}/api/wingo-1min?page=${p}`);      const data = await res.json();
...
const res = await fetch(`${API_URL}/api/wingo-1min/my-bets?page=${p}`, {        headers: { Authorization: `Bearer ${token}` },
      });
...
export default GameHistory1Min;